...
export function FooterSection({ profile }: FooterSectionProps) {
  return (
    <footer className="py-20 px-6 border-t text-center min-w-screen border-cyan-400 dark:border-violet-700 bg-white dark:bg-gray-900 transition-colors duration-500">

      ...
      <div className="relative z-10 max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="block md:hidden">
          {profile ? (
            ...
            <Skeleton className="w-[220px] h-[220px] rounded-xl mx-auto mb-8" />
          )}
        </div>
        ...
        <div>
          {profile ? (
            ...
            <div className="space-y-4 mb-6">
              <Skeleton className="h-10 w-2/3 mx-auto md:mx-0" />
        ...
        <div className="hidden md:block">
          {profile ? (
            ...
            <Skeleton className="w-[320px] h-[320px] rounded-xl mx-auto" />
          )}
        </div>
      </div>

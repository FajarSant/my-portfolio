                      ...
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex space-x-2">
                          {project.live_url && (
                            ...
                            >
                              <ExternalLink className="w-5 h-5 text-gray-600 dark:text-gray-400 hover:text-cyan-400 cursor-pointer transition-colors" />
                            </a>
                          )}
                          {project.github_url && (
                            <a
                              ...
                              onClick={(e) => e.stopPropagation()}
                            >
                              <Github className="w-5 h-5 text-gray-600 dark:text-gray-400 hover:text-cyan-400 cursor-pointer transition-colors" />
                            </a>
                          )}
                        </div>
                      </div>
                      <h3
                        className={`text-xl font-bold mb-3 transition-colors text-gray-900 dark:text-white group-hover:${colorScheme.text}`}
                      >
                        {project.title}
                      </h3>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.technologies.slice(0, 3).map((tech) => (
                          <Badge
                            key={tech}
                            variant="secondary"
                            className="bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-300 text-xs"
                          >
                            {tech}
                          </Badge>
                        ))}
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedProject.technologies.map((tech) => (
                        <Badge
                          key={tech}
                          variant="secondary"
                          className="bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
                        >
                          {tech}
                        </Badge>
                      ))}

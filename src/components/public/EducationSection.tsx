        ...
        <div className="space-y-8">
          {education.length > 0 ? (
                            ...
                            <div className="text-right">
                              ...
                              {edu.gpa && (
                                <div>
                                  <Badge
                                    variant="secondary"
                                    className="bg-gray-300/40 dark:bg-gray-700 text-gray-900 dark:text-gray-300"
                                  >
                                    GPA: {edu.gpa}
                                  </Badge>
                                </div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <Card className="bg-white/90 dark:bg-gray-900/70 border-gray-200 dark:border-gray-800 backdrop-blur-sm">
